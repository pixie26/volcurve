...
def apiInstrumentsFxVol():
    try: 
        response = apiGet(url_endpoints, '/v1/instruments?type=fxVol', acceptApplicationJson(headers), "instrumentsFxVol.json", http_proxy)
...
def apiSeries():
    try: 
        ...
        body = {
            "code": "FXO.EUR.USD.VOL.7Y.PUT10.CLOSE.LONDON_CLOSE.TENOR.STD.DFLT",
