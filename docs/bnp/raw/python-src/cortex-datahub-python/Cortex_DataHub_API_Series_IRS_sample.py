...
def apiInstrumentsIrs():
    try: 
        response = apiGet(url_endpoints, '/v1/instruments?type=irs', acceptApplicationJson(headers), "instrumentsIrs.json", http_proxy)
...
def apiSeries():
    try: 
        ...
        body = {
            "code": "SWAP.AUD.BBSW.3M.CSA_AUDOIS.30Y",
