...
def apiFile():
    try:
        # call first endpoint to get available dates
        response = apiGet(url_endpoints, '/v1/data/thematicBasket/dates', 
        ...
        # call second endpoint, get the list of the available documents for the last date
        response = apiGet(url_endpoints, '/v1/data/thematicBasket/dates/' + str(date) + '/names', 
                          acceptApplicationJson(headers), 
                          "documents.json",
                          http_proxy)
        # check the result
        ...
        response = apiGet(url_endpoints, '/v1/data/thematicBasket/dates/' + str(date) + '/names/' + str(document),
